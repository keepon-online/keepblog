<template>
  <div class="panel-group">
    <el-row :gutter="20">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('categories')">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('tags')">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('visits')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">总访问</div>
            <count-to
              :start-val="0"
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          <div class="card-panel-icon-wrapper icon-reads">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">总阅读</div>
            <count-to
              :start-val="0"
