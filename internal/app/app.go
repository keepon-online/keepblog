...
import (
	...
	appconfig "gitee.com/jieepre/keepblog/internal/config"
	"gitee.com/jieepre/keepblog/internal/core"
	...
	"gitee.com/jieepre/keepblog/internal/version"
...
func (app *Application) Initialize() error {
	...
	// 存量数据回填：旧库的 word_count/post_slug 启动时补齐（幂等）
	core.BackfillPostWordCount(global.GORM)
	core.BackfillPostSlug(global.GORM)
