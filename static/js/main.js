document.addEventListener('DOMContentLoaded', function () {
    ...
    function addPhotoFigcaption() {
        document.querySelectorAll('#post-container img').forEach(function (item) {
    ...
    const scrollFnToDo = function () {
        ...
        if (isToc) {
            ...
            scrollPercent = currentTop => {
                ...
                if ($tocPercentage) $tocPercentage.textContent = percentage + '%'
            }
    ...
    const clickFnOfTagHide = function () {
        const $hideInline = document.querySelectorAll('#post-container .hide-button')
    ...
    const tabsFn = {
        clickFnOfTabs: function () {
            document.querySelectorAll('#post-container .tab > button').forEach(function (item) {
                item.addEventListener('click', function (e) {
                    const $this = this
        ...
        backToTop: () => {
            document.querySelectorAll('#post-container .tabs .tab-to-top').forEach(function (item) {
                item.addEventListener('click', function () {
