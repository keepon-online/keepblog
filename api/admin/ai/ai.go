...
func (h *Handler) Edit(c *gin.Context) {
	...
	cfgMax := h.Service.AIService.MaxTokens()

	usage, err := h.Service.AIService.Client().StreamChat(ctx, aiclient.StreamRequest{
		Messages:  msgs,
		MaxTokens: cfgMax,
	...
	h.Service.AIService.RecordUsage(req.Task, usage)
